/**
 * Controled element: use indivisual field state for each input field 
 */
    ...
    return (
        <div className="flex justify-center flex-col gap-10 items-center h-[100vh]">
            ...
            <form action="" onSubmit={handleSubmit} className={formStyle}>
                <input type="text" onChange={handleNameChange} name="name" placeholder="Name" className={inputStyles} />
